    ...
    <div>
      ...
      <table v-if="clients.length >0" class="table w-full mx-auto mt-5 mb-20">
        <thead class="text-white bg-indigo-500">
          <tr>
            <th scope="col" class="px-2 py-4 border">ID</th>
            <th scope="col" class="py-4 border">Name</th>
            <th scope="col" class="py-4 border">Secret</th>
            <th scope="col" class="py-4 border">Actions</th>
          </tr>
        </thead>
