      ...
      <div class="fixed inset-0 flex items-center">
        ...
        <div class="relative mx-6 md:mx-auto w-full md:w-1/2 lg:w-1/3 z-20 m-8">
          <div class="shadow-lg bg-white rounded-lg p-8">
            ...
            <h1 class="text-center text-2xl text-blue-600">Create Token</h1>
            ...
            <form class="pt-6 pb-2 my-2" @submit.prevent="store">
              <div class="mb-4">
                ...
                <input
                  ...
                  class="block appearance-none outline-none w-full h-full border focus:border-blue-500  bg-gray-100 text-gray-700 px-3 py-3 pr-3 pl-9 rounded"
          ...
          <div class="shadow-lg bg-white rounded-lg p-8">
            <div class="flex justify-end mb-6">
              <button @click="showAccessTokenModal = false">
                <span class="mr-2 text-red-500">Close</span>
                <span>
                  <i class="fa fa-times"/>
                </span>
              </button>
            ...
            <h1 class="text-center text-2xl text-teal-600 pb-5">Personal Access Token</h1>
