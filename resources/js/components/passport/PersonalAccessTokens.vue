  ...
  <div>
    <div>
      ...
      <table v-if="tokens.length >0" class="table w-full mx-auto mt-5 mb-20">
        <thead class="py-3 text-white bg-indigo-500">
          <tr>
            <td class="py-4 pl-4 text-left border font-extraextrabold">Name</td>
            <td class="py-4 pr-4 text-right border font-extraextrabold">Actions</td>
          </tr>
        </thead>

        <tbody>
          <tr v-for="(token,index) in tokens" :key="index">
            <td scope="row" class="py-4 pl-4 text-left border">{{ token.name }}</td>
            <td scope="row" class="py-4 pr-4 text-right border">
