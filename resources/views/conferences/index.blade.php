                        ...
                        <li>
                            @if (Auth::check() && $conference->isFavorited())
                                <a href="/conferences/{{ $conference->id  }}/unfavorite"
                                   class="fav-button fav-button--faved"><span
                                        class="glyphicon glyphicon-star"></a>
                            @else
                                <a href="/conferences/{{ $conference->id  }}/favorite"
                                   class="fav-button"><span
                            ...
                            @if ($conference->joindin_id)
                                <a href="http://joind.in/event/view/{{ $conference->joindin_id }}">
                                    <span class="label-joindin"><img
                                            src="/img/joindin-button.png"></span>
                                </a>
                            @endif
                            ...
                            <p>{{ mb_substr($conference->description, 0, 100) }}
                                ...</p>
                        </li>
                    @empty
